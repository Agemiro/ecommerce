...
describe('ProductSearchComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      providers: [
        {
          provide: ProductSearchService, // QUANDO O COMPONENTE VISUALIZAR ESSSE SERVIÇO...
          useValue: {
            searchByName: () => of(mockProducts), // NA VERDADE ELE VAI USAR ESSA IMPLEMENTAÇÃO (INVERSÃO DE DEPENDÊNCIA).
          },
        },
      ],
    }).compileComponents();
